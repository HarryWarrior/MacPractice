...
- It generates all three outreach messages in a single call using the competitor playbook, pain points, decision maker name, and growth signals:
  - **Email** — 3 subject line variants + complete body
  - **WhatsApp** — short conversational message; displayed with a one-click `wa.me` link pre-filled with the prospect's phone number
  - **LinkedIn DM** — connection request message formatted for the platform's character limits
...
5. Click **Generate Outreach** — the AI generates a personalized **email** (3 subject variants), a **WhatsApp message** with a one-click send button, and a **LinkedIn DM** in one shot
6. Edit any draft, enter your test email in the **To** field, and click **Send**. Use the WhatsApp button to open the pre-filled chat instantly
